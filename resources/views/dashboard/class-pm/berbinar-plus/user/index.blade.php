  ...
  <div class="flex flex-col w-full bg-gray-100">
    <div class="w-full">
      <div class="py-4 md:pt-12 md:pb-7">
        ...
        <a href="{{ route("dashboard.berbinar-user.create") }}" class="mt-8 inline-flex items-start justify-start rounded-lg bg-primary px-6 py-3 text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-3">
                            ...
                            {{-- @foreach ($berbinarpUsers as $index => $user) --}}
                                <tr class="border-b border-gray-200 hover:bg-gray-200 odd:bg-gray-50 even:bg-white">
                                    ...
                                    <td class="whitespace-no-wrap sticky-col sticky-col-2 px-6 py-4">
                                        {{-- {{ $user->first_name }} {{ $user->last_name }} --}} Eka Putra
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->created_at ? $user->created_at->format('d-m-Y') : '-' }} --}} 10-10-2025
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->email }} --}} ekaputra@gmail.com
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->enrollment && $user->enrollment->class ? $user->enrollment->class->title : '-' }} --}} Graphic Designer
                                    </td>
                                    <td class="whitespace-no-wrap flex items-center justify-center gap-2 px-6 py-4">
                                        <!-- Tombol Detail -->
                                        <a href="{{ route('dashboard.berbinar-user.show'{{--, $user->id --}} ) }}" class="inline-flex items-start justify-start rounded p-2 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2" style="background-color: #3b82f6">
                                            <i class="bx bxs-show text-white"></i>
                                        </a>
                                        <!-- Tombol Edit -->
                                        <a href="{{ route('dashboard.berbinar-user.edit'{{--, $user->id --}} ) }}" class="inline-flex items-start justify-start rounded p-2 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2" style="background-color: #e9b306">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-200 odd:bg-gray-50 even:bg-white">
                                    ...
                                    <td class="whitespace-no-wrap sticky-col sticky-col-2 px-6 py-4">
                                        {{-- {{ $user->first_name }} {{ $user->last_name }} --}} Dwi Putra
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->created_at ? $user->created_at->format('d-m-Y') : '-' }} --}} 15-10-2025
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->email }} --}} dwiputra@gmail.com
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->enrollment && $user->enrollment->class ? $user->enrollment->class->title : '-' }} --}} Graphic Designer
                                    </td>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-200 odd:bg-gray-50 even:bg-white">
                                    ...
                                    <td class="whitespace-no-wrap sticky-col sticky-col-2 px-6 py-4">
                                        {{-- {{ $user->first_name }} {{ $user->last_name }} --}} Tri Putri
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->created_at ? $user->created_at->format('d-m-Y') : '-' }} --}} 20-10-2025
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->email }} --}} dwiputri@gmail.com
                                    </td>
                                    <td class="whitespace-no-wrap text-center px-6 py-4">
                                        {{-- {{ $user->enrollment && $user->enrollment->class ? $user->enrollment->class->title : '-' }} --}} Graphic Designer
                                    </td>
    ...
    function openDeleteModal(userId) {
        deleteForm.action = `/dashboard/berbinar-user/${userId}`;
