            ...
            <div class="w-full">
                <div class="py-4 md:pt-12 md:pb-7">
                    <div>
                        ...
                        <a href="{{ route('dashboard.admin.class.create') }}"
                                    ...
                                    @foreach ($classes as $i => $class)
                                        <tr
                                            ...
                                            <td class="whitespace-no-wrap flex items-center justify-center gap-2 px-6 py-4">
                                                <a href="{{ route('dashboard.admin.class.show', $class->id) }}"
                                                ...
                                                <!-- Tombol Edit -->
                                                <a href="{{ route('dashboard.admin.class.edit', $class->id) }}"
...
@section('script')
    <script>
        ...
        function openDeleteModal(classId) {
            deleteForm.action = `/dashboard/admin/class/${classId}`;
