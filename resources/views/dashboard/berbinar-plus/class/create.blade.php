                ...
                <form action="{{ route('dashboard.kelas.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" placeholder="UI/UX Designer" class="peer w-full rounded-lg border-2 border-gray-300 px-4 py-2 shadow-sm mb-1" required />
                        </div>

                        <div>
                            <label class="text-lg">Nama Instruktur</label>
                            <input type="text" name="instructor_name" placeholder="Elon Musk" class="peer w-full rounded-lg border-2 border-gray-300 px-4 py-2 shadow-sm mb-1" required />
                        </div>

                        <div>
                            <label class="text-lg">Jabatan Instruktur</label>
                            <input type="text" name="instructor_title" placeholder="UI/UX Lead at Astra International" class="peer w-full rounded-lg border-2 border-gray-300 px-4 py-2 shadow-sm mb-1" required />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" name="thumbnail" id="thumbnailInput" class="peer w-full rounded-lg border-2 border-gray-300 px-4 py-2 shadow-sm mb-1" required accept="image/*" />
