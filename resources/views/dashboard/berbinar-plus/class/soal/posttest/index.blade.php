...
@section('content')
                ...
                <div class="py-4 md:pt-12 md:pb-7">
                    <div>
                        <div class="mb-2 flex items-center gap-2">
                            ...
                            <p class="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-2xl lg:text-4xl">Daftar Soal Post Test</p>
                        </div>
    ...
    <div id="createQuestionModal" class="fixed inset-0 z-10 flex hidden items-center justify-center bg-black bg-opacity-50">
        <div class="relative w-full max-w-xl rounded-xl bg-white p-6 text-center">
            ...
            <form id="createSoalForm" method="GET" action="{{ route("dashboard.kelas.post-test.index") }}">
                @csrf
