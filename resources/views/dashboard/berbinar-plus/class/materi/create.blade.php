    ...
    <section class="flex w-full">
        <div class="flex w-full flex-col">
            <div class="py-4 md:pb-7 md:pt-12">
                ...
                <p class="w-full text-disabled">Formulir untuk menambahkan materi baru ke dalam program Berbinar+ secara
                ...
                <form action="{{ route('dashboard.materi.store', ['class' => $classId]) }}" method="POST"
                    ...
                    <div class="flex flex-col gap-3">
                        <div>
                            ...
                            <input type="text" name="title" placeholder="1. Produksi Visual"
                        ...
                        <div>
                            ...
                            <input type="text" name="video_url" placeholder="www.youtube.com"
