                    ...
                    <form id="internshipForm" method="POST" action="">
                        <div id="registrationForm1" class="registration-form">
                            ...
                            <div class="mb-4 flex items-center">
                                <input type="checkbox"
                                    class="form-checkbox h-5 w-5 bg-gray-100 border border-gray-500 rounded-[5px] shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                        ...
                        <div id="registrationForm2" class="hidden">
                            ...
                            <div class="mb-4">
                                ...
                                <label for="paket-layanan" class="text-sm">*Mohon diperhatikan bahwa harga layanan
                                    konseling adalah per jam </label>
                                <div x-data="{
                                    open: false,
                                    selected: '',
                                    options: [
                                    ...
                                    <button @click="open = !open" type="button"
                                        ...
                                        <img src="{{ asset('assets/images/landing/produk/emo/chevron.png') }}"
                                            alt="" class="transform transition-transform w-[.9rem] mr-1">
                                    </button>
                                    <div x-show="open"
                                        class="absolute max-sm:max-h-40 max-sm:overflow-y-auto left-0 mt-2 w-full bg-white border border-gray-300 rounded-md shadow-lg z-10">
                                        <ul>
                            ...
                            <div class="mb-4 rounded-lg" style="background-color: white;">
                                ...
                                <div class="relative w-full flex items-center">
                                    <input type="file" id="bukti_transfer" name="bukti_transfer"
                                        ...
                                        required />
                                    <div
                                        class="mt-1 block w-full h-10 pl-2 bg-gray-100 border border-gray-100 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary pointer-events-none cursor-pointer content-center flex items-center">
                                        <button type="button"
                                            class="pointer-events-none border flex justify-between gap-2 py-[2px] px-2 border-[#B3B3B3] rounded-md cursor-pointer items-center">
