    ...
    <section class="flex w-full">
        <div class="flex w-full flex-col">
            ...
            <div class="rounded-lg bg-white px-4 py-4 shadow-md md:px-8 md:py-7 xl:px-10 mb-7">
                {{-- <form id="berbinarForm" action="{{ route("dashboard.berbinar-user.update", $user->id) }}" method="POST" enctype="multipart/form-data"> --}}
                <form id="berbinarForm" action="{{ route("dashboard.berbinar-user.index") }}" method="GET">
                    @csrf
                    @method("PATCH")
                    ...
                    <div class="flex flex-col">
                        <div class="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" placeholder="Nama Depan" class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm" required value="{{-- {{ $user->first_name }} --}}" />
                            </div>
                            <div>
                                <label class="text-lg">Nama Belakang</label>
                                <input type="text" id="last_name" name="last_name" placeholder="Nama Belakang" class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm" required value="{{-- {{ $user->last_name }} --}}" />
                            </div>
                            <div>
                                <label class="text-lg">Jenis Kelamin</label>
                                <select id="gender" name="gender" class="peer w-full rounded-lg border border-gray-300 bg-white px-4 py-4 shadow-sm" required>
                            ...
                            <div>
                                ...
                                <input type="number" id="age" name="age" placeholder="Usia Kamu Sekarang" class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm" required value="{{-- {{ $user->age }} --}}" />
                            </div>
                            <div>
                                <label class="text-lg">Nomor WhatsApp</label>
                                <input type="text" id="wa_number" name="wa_number" placeholder="08112345XXXX" class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm" required value="{{-- {{ $user->wa_number }} --}}" />
                            </div>
                            <div>
                                <label class="text-lg">Email</label>
                                <input type="email" id="email" name="email" placeholder="sobatbinar@gmail.com" class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm" required value="{{-- {{ $user->email }} --}}" />
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <select id="kelas" name="kelas" class="peer w-full rounded-lg border border-gray-300 bg-white px-4 py-4 shadow-sm" required>
                            ...
                            <div>
                                ...
                                <select id="paket" name="paket" class="peer w-full rounded-lg border border-gray-300 bg-white px-4 py-4 shadow-sm" required>
                        ...
                        <div id="confirmModal" class="fixed inset-0 z-50 flex hidden items-center justify-center bg-black/40">
                            ...
                            >
                                ...
                                <div class="mt-6 flex justify-center gap-3">
                                    ...
                                    <a href="{{ route("dashboard.berbinar-user.index") }}" class="rounded-[5px] bg-gradient-to-r from-[#74AABF] to-[#3986A3] px-6 py-2 font-medium text-white">Ya, Batalkan</a>
                                </div>
                            </div>
                        </div>
                    </div>
