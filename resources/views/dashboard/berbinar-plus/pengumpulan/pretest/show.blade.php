                ...
                <div class="py-4 md:pt-12 md:pb-7">
                    <div>
                        <div class="mb-2 flex items-center gap-2">
                            <a
                                href="{{ route('dashboard.pendaftar.pengumpulan-tes.index', ['user' => $userModel->id, 'enrollment' => $enrollmentModel->id]) }}">
                            ...
                            <p class="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-2xl lg:text-4xl">
                                Detail Jawaban Pre Test</p>
                        </div>
                        <p class="w-full text-disabled">
                            Halaman yang menampilkan detail jawaban peserta pada Pre Test, lengkap dengan hasil penilaian
