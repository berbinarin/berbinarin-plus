                    ...
                    <div>
                        <div class="mb-2 flex items-center gap-2">
                            ...
                            <p class="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-2xl lg:text-4xl">
                                Data Peserta Pre Test</p>
                        </div>
                        <p class="w-full text-disabled">
                            Halaman yang menampilkan rangkuman data hasil Pre Test peserta Berbinar+, sehingga memudahkan
                            admin dalam melakukan pengecekan, penilaian, dan pengelolaan data kelas.
                        </p>
                    </div>
                </div>
                            ...
                            <table id="example" class="display min-w-full pt-5 leading-normal">
                                <thead>
                                    <tr class="mt-4">
                                        ...
                                        <th
                                            class="sticky-col sticky-col-2 bg-white px-6 py-3 text-center text-base font-bold leading-4 tracking-wider text-black">
                                            Kelas
                                        </th>
                                        <th
                                            class="sticky-col sticky-col-2 bg-white px-6 py-3 text-center text-base font-bold leading-4 tracking-wider text-black">
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-200 odd:bg-gray-50 even:bg-white">
                                        ...
                                        <td class="whitespace-no-wrap sticky-col sticky-col-2 text-center px-6 py-4">
                                            <div class="inline-flex items-center justify-center">
                                                <div id="status" class="text-center px-3 py-1 rounded-lg">
                                                    {{-- {{ $test->name }} --}} Progress</div>
                                            </div>
                                        </td>
                                        <td class="whitespace-no-wrap flex items-center justify-center gap-2 px-6 py-4">
                                            <a href="{{ route('dashboard.pendaftar.pengumpulan-tes.pre-test.show') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('[id="status"]').forEach(function(el) {
                ...
                el.classList.remove('bg-white', 'bg-gray-50', 'bg-gray-100', 'text-black', 'text-white',
                    'text-gray-700', 'text-gray-800', 'bg-cyan-500', 'bg-green-500', 'text-blue-800',
                    'text-green-800');
