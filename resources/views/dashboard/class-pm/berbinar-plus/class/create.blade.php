                    ...
                    <div class="flex flex-col">
                        <div>
                            <label class="text-lg">Nama Kelas</label>
                                <div class="relative w-full">
                                    <input type="text" id="title" name="title" placeholder=" " class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm mb-1" />
                        ...
                        <div>
                            <label class="text-lg">Deskripsi Kelas</label>
                                <div class="relative w-full">
                                    <textarea id="description" name="description" placeholder=" " rows="4" class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm resize-none"></textarea>
