...
<div class="lg:px-6">
    ...
    <div class="fixed h-0 block -z-10 pointer-events-none">
        <div class="fixed translate-y-[90%] lg:-translate-y-[10%] -translate-x-[50%] bg-[#A2D7F0] -z-10 pointer-events-none" style="width: 300px; height: 300px; border-top-left-radius: 420px; border-bottom-left-radius: 420px; border-top-right-radius: 420px; filter: blur(60px); opacity: 0.9; top: -100px"></div>
    </div>
    ...
    <div class="tab-content flex-col w-full">
        <div class="z-40">
            ...
            <div class="w-full pb-6 flex flex-row lg:hidden items-center gap-8">
                <div class="rounded-3xl bg-[#C2E2F3] text-[#005D8E] text-center py-2 px-6 text-lg font-semibold">Profile Saya</div>
                <a href="{{ route('auth.berbinar-plus.login') }}" class="flex flex-row gap-1">
