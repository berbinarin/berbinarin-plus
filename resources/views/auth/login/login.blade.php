...
@section('content')
    <section class="fixed inset-0 flex h-full w-full flex-col bg-cover bg-center bg-no-repeat"
        style="background-image: url('{{ asset('assets/images/auth/loginbg.png') }}')">
        <!-- icon -->
        <div class="ml-[36px] mt-[35px] flex flex-row items-center justify-start gap-4">
            <img src="{{ asset('assets/images/landing/logo/logo-berbinar.png') }}" alt="Logo Berbinar"
                class="h-[67px] w-[67px]" />
            ...
            <div class="-mt-16 flex min-h-screen items-center justify-center bg-none">
                <div
                    ...
                    <div class="flex w-full flex-col items-start justify-start gap-3">
                        ...
                        <div class="flex w-full flex-col items-start justify-start gap-2">
                            ...
                            <div
                                ...
                                <img src="assets/images/auth/Circled Envelope.png" alt="Username" class="mx-3 size-8" />
                        ...
                        <div class="flex w-full flex-col items-start justify-start gap-2">
                            ...
                            <div
                                class="flex h-[47px] w-full items-center justify-start gap-3 rounded-lg bg-white outline outline-[0.67px] outline-offset-[-0.67px] outline-stone-300/80">
                                <img src="assets/images/auth/Secure.png" alt="Username" class="mx-3 size-8" />
                    ...
                    <button type="submit"
                        ...
                        <div class="absolute left-[176.67px] top-[14.67px] text-center text-sm font-bold text-white">
                            Sign in
                        </div>
                    </button>
                </div>
