...
@section('content')
    ...
    <div class="hidden lg:flex flex-row w-full overflow-hidden">
        <img src="{{ asset('assets/images/landing/login/login-image.webp') }}" alt="" class="h-full max-h-[100vh] z-50">
        <div class="w-full flex flex-col justify-center items-center">
            <div class="w-[60%] flex flex-col">
                <!-- BLUR SETENGAH LINGKARAN PEMBATAS KIRI -->
                <div class="relative z-0 hidden h-0 lg:block">
                    <div class="absolute -translate-y-[60%] z-0 -left-64 bg-[#A2D7F0]" style="width: 300px; height: 300px; border-top-left-radius: 420px; border-bottom-left-radius: 420px; border-top-right-radius: 420px; filter: blur(60px); opacity: 0.9; top: -100px"></div>
                </div>
                ...
                <div class="relative hidden h-0 lg:block">
                    <div class="absolute -translate-y-[60%] z-0 -right-64 bg-[#A2D7F0]" style="width: 300px; height: 300px; border-top-left-radius: 420px; border-bottom-left-radius: 420px; border-top-right-radius: 420px; filter: blur(60px); opacity: 0.9; top: 100px"></div>
                </div>
            </div>
        </div>
    </div>
