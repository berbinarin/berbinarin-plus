            ...
            <div class="w-full">
                <div class="py-4 md:pt-12 md:pb-7">
                    <div>
                        ...
                        <a href="{{ route('dashboard.admin.user.create') }}"
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-200 odd:bg-gray-100 even:bg-white">
                                        ...
                                        <td class="whitespace-no-wrap sticky-col sticky-col-2 px-6 py-4">
                                            {{-- {{ $user->first_name }} {{ $user->last_name }} --}} Lele
                                        </td>
                                        <td class="whitespace-no-wrap text-center px-6 py-4">
                                            {{-- {{ $user->created_at ? $user->created_at->format('d-m-Y') : '-' }} --}} df
                                        </td>
                                        <td class="whitespace-no-wrap text-center px-6 py-4">
                                            {{-- {{ $user->email }} --}} df
                                        </td>
                                        <td class="whitespace-no-wrap text-center px-6 py-4">
                                            {{-- {{ $user->enrollment && $user->enrollment->class ? $user->enrollment->class->title : '-' }} --}} df
                                        </td>
                                        <td class="whitespace-no-wrap flex items-center justify-center gap-2 px-6 py-4">
                                            <!-- Tombol Detail -->
                                            <a href="{{ route('dashboard.admin.user.show', $user->id) }}"
                                            ...
                                            <!-- Tombol Edit -->
                                            <a href="{{ route('dashboard.admin.user.edit', $user->id) }}"
