    ...
    <section class="flex w-full">
        <div class="flex w-full flex-col">
            ...
            <div class="rounded-lg bg-white px-4 py-4 shadow-md md:px-8 md:py-7 xl:px-10 mb-7">
                ...
                <form action="{{ route('dashboard.berbinar-class.index') }}" method="GET">
                        ...
                        <div>
                            <label class="text-lg">Nama Kelas</label>
                                <div class="relative w-full">
                                    {{-- <input type="text" id="title" name="title" placeholder=" " class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm" value="{{ $class->title}}"/> --}}
                                    <input type="text" id="title" name="title" placeholder=" " class="peer w-full rounded-lg border border-gray-300 px-4 py-4 shadow-sm" value="Graphic Designer"/>
                        ...
                        <div>
                            <label class="text-lg">Deskripsi Kelas</label>
                                <div class="relative w-full">
                                    ...
                                    <textarea id="description" name="description" placeholder=" " rows="4" class="peer w-full rounded-lg border-gray-300 px-4 py-4 shadow-sm resize-none" >Kelas ini memberikan pelajaran desain grafis</textarea>
