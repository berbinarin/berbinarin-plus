                ...
                <div class="py-4 md:pt-12 md:pb-7">
                    <div>
                        <div class="mb-2 flex items-center gap-2">
                            <a href="{{ route('dashboard.pendaftar.pengumpulan-tes.post-test.index') }}">
                                <img src="{{ asset('assets/images/dashboard/svg-icon/dashboard-back.webp') }}" alt="Back Btn" />
                            </a>
                            <p class="text-base font-bold leading-normal text-gray-800 sm:text-lg md:text-2xl lg:text-4xl">Detail Jawaban Post Test</p>
                        </div>
                        <p class="w-full text-disabled">
                            Halaman yang menampilkan detail jawaban peserta pada Post Test, lengkap dengan hasil penilaian dan data peserta untuk memudahkan proses evaluasi.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col gap-5 w-1/3">
                            ...
                            <div class="bg-[#106681] text-white flex flex-col gap-5 justify-between px-6 py-4 rounded-xl">
                                <div class="flex flex-col gap-1">
                                    <h1>benar</h1>
                                    <h2 class="text-xl font-medium">20 Soal</h2>
                                </div>
                                <div class="flex flex-col gap-1">
                                    <h1>salah</h1>
                                    <h2 class="text-xl font-medium">0 Soal</h2>
                                </div>
                            </div>
                            ...
                            <div class="bg-white flex flex-col gap-5 justify-between px-6 py-4 rounded-xl">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <h2 class="text-xl font-medium">31 Juli 2025</h2>
                                </div>
                                <div class="flex flex-col gap-1">
                                    <h1>status</h1>
