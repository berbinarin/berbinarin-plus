            ...
            <div class="rounded-lg bg-white px-4 py-4 shadow-md md:px-8 md:py-7 xl:px-10 mb-7">
                ...
                <div class="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="mb-2 flex flex-col">
                        ...
                        <p class="text-lg font-semibold">Eka Putra</p>
                    ...
                    <div class="mb-2 flex flex-col">
                        ...
                        <p class="text-lg font-semibold">ekaputra@gmail.com</p>
                    </div>
                    ...
                    <div class="mb-2 flex flex-col">
                        ...
                        <p class="text-lg font-semibold">20 Tahun</p>
                    </div>
                </div>
                ...
                <div>
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="mb-2 flex flex-col">
                            ...
                            <p class="text-lg font-semibold">A+ Online Weekday (Rp36.000 - Rp120.000/jam)</p>
                        </div>
